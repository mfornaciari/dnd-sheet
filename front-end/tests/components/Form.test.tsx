...
describe("Form", () => {
  ...
  it("renders and works correctly", async () => {
    render(<Form data={fetchedDataMock.data as FetchedData} />);
    ...
    await user.selectOptions(raceInput, "Anão");
    await user.selectOptions(characterClassInput, "Bárbaro");
    ...
    await user.type(xpInput, "0000"); // Total 3.000.000
    ...
    await user.upload(loadButton, mockFile);
